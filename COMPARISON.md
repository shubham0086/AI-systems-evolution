...
|------|-----------|----------------------|-------|--------|-----------|----------------|------------|
| **00** Plain code | Hard-coded script | Human (at write time) | — | — | 0 | Total | The task never varies |
| **01** Single call | One prompt | Human (the prompt) | — | — | 1 | High | A one-shot answer is enough |
